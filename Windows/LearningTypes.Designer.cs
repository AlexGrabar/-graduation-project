namespace Schedule.Windows {
	partial class LearningTypes {
		...
		private void InitializeComponent() {
			...
			this.label6.Text = "Название типа занятий";
			// 
			// EntityName
			// 
			...
			this.Table.Location = new System.Drawing.Point(10, 4);
			...
			this.Table.Size = new System.Drawing.Size(244, 545);
			...
			this.panel1.Location = new System.Drawing.Point(279, 252);
			...
			this.label1.Text = "Название типа занятий";
			// 
			// RefreshDataTable
			// 
			...
			this.Name = "LearningTypes";
			this.ShowIcon = false;
			this.Text = "Типы занятий";
